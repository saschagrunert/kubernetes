...
func (f *FakeRuntime) GetOCIObjectMount(_ context.Context, image kubecontainer.ImageSpec) (*kubecontainer.OCIMount, error) {
	f.Lock()
	defer f.Unlock()

	f.CalledFunctions = append(f.CalledFunctions, "GetOCIObjectMount")
	return nil, f.Err
}
