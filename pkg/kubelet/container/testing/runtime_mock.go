...
// GetOCIObjectMount provides a mock function with given fields: ctx, image
func (_m *MockRuntime) GetOCIObjectMount(ctx context.Context, image container.ImageSpec) (*container.OCIMount, error) {
	ret := _m.Called(ctx, image)

	if len(ret) == 0 {
		panic("no return value specified for GetOCIObjectMount")
	}

	var r0 *container.OCIMount
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, container.ImageSpec) (*container.OCIMount, error)); ok {
		return rf(ctx, image)
	}
	if rf, ok := ret.Get(0).(func(context.Context, container.ImageSpec) *container.OCIMount); ok {
		r0 = rf(ctx, image)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*container.OCIMount)
		}
	}
...
// MockRuntime_GetOCIObjectMount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOCIObjectMount'
type MockRuntime_GetOCIObjectMount_Call struct {
	*mock.Call
}

// GetOCIObjectMount is a helper method to define mock.On call
//   - ctx context.Context
//   - image container.ImageSpec
func (_e *MockRuntime_Expecter) GetOCIObjectMount(ctx interface{}, image interface{}) *MockRuntime_GetOCIObjectMount_Call {
	return &MockRuntime_GetOCIObjectMount_Call{Call: _e.mock.On("GetOCIObjectMount", ctx, image)}
}

func (_c *MockRuntime_GetOCIObjectMount_Call) Run(run func(ctx context.Context, image container.ImageSpec)) *MockRuntime_GetOCIObjectMount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(container.ImageSpec))
	})
	return _c
...
func (_c *MockRuntime_GetOCIObjectMount_Call) Return(_a0 *container.OCIMount, _a1 error) *MockRuntime_GetOCIObjectMount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRuntime_GetOCIObjectMount_Call) RunAndReturn(run func(context.Context, container.ImageSpec) (*container.OCIMount, error)) *MockRuntime_GetOCIObjectMount_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRuntime) PullImage(ctx context.Context, image container.ImageSpec, pullSecrets []corev1.Secret, podSandboxConfig *v1.PodSandboxConfig) (*v1.PullImageResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, container.ImageSpec, []corev1.Secret, *v1.PodSandboxConfig) (*v1.PullImageResponse, error)); ok {
		return rf(ctx, image, pullSecrets, podSandboxConfig)
	}
	if rf, ok := ret.Get(0).(func(context.Context, container.ImageSpec, []corev1.Secret, *v1.PodSandboxConfig) *v1.PullImageResponse); ok {
...
func (_c *MockRuntime_PullImage_Call) Return(_a0 *v1.PullImageResponse, _a1 error) *MockRuntime_PullImage_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRuntime_PullImage_Call) RunAndReturn(run func(context.Context, container.ImageSpec, []corev1.Secret, *v1.PodSandboxConfig) (*v1.PullImageResponse, error)) *MockRuntime_PullImage_Call {
	_c.Call.Return(run)
	return _c
}
