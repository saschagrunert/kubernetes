...
func (f *FakeRuntimeHelper) GenerateRunContainerOptions(_ context.Context, pod *v1.Pod, container *v1.Container, podIP string, podIPs []string, ociVolumes map[string]kubecontainer.OCIMount) (*kubecontainer.RunContainerOptions, func(), error) {
